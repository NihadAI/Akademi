  ...
  return (
    <div className="col-span-12 rounded-lg border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
      <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
        <div>
          <h2 className='w-full font-bold text-nowrap text-xl'>School Performance</h2>
        </div>
        <div className="flex w-full flex-wrap justify-end gap-1 sm:gap-5">
          ...
          <div className="flex min-w-47.5">
            ...
            <div className="w-1/2">
              <p className="font-semibold text-secondary">Last Week</p>
            </div>
          </div>
        </div>
      </div>
